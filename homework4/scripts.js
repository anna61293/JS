...
//   /* Заказ пользователя хранится в виде объекта следующего формата. "имя-продукта":"количество-единиц" */
  ...
  function Cashier (name, productDatabase){
      ...
      this.setCustomerMoney = function(newCustomerMoney){
          this.customerMoney = newCustomerMoney;
      }
      this.countTotalPrice = function (newOrder){
          let summ = 0;
          let price = 0;
          for (let elemOrd in newOrder){
              for (let elemProd in productDatabase){
                if(elemOrd === elemProd){
                price = productDatabase[elemProd] * newOrder[elemOrd];
              };
            };
              summ += price;
          };
     ...
     this.countChange = function(totalPrice) {
      if (this.customerMoney > totalPrice) {
        this.countChange = this.customerMoney - totalPrice;
